      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-6 border rounded-lg bg-green-50">
            ...
            <p className="text-gray-600">Check class schedule</p>
          </div>
          <div className="p-6 border rounded-lg bg-purple-50">
            <h3 className="font-semibold text-lg mb-2">Announcements</h3>
            <p className="text-gray-600">Latest school news</p>
          </div>
        </div>
        <div className="p-6 border rounded-lg">
          <h2 className="text-2xl font-semibold mb-4">Welcome</h2>
          <p className="text-gray-700">Student portal content coming soon...</p>
        </div>
      </div>
    </div>
  )
